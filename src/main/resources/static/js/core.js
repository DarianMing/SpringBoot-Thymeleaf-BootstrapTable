...
var Core = (function () {
    ...
    /*当返回数据为空时调用refreshTable方法刷新表格有异常，推荐使用refreshTableData*/
    /*刷新表格 ：flag-是否跳转到当前页。默认首页*/
    core.refreshTableData = function (id , flag) {
    ...
    /*自定义文案的询问框*/
    core.customConfirm = function(content ,btnConfirm ,btnCancel ,d){
        layer.confirm(content, {
            icon: 3,
            title: "系统提示",
